				...
				<v-container px-md-5>
					<v-layout column>
						...
						<v-btn-toggle class="mb-5" v-model="gender">
							<v-btn class="toggle_btn" flat outline color="primary" value="male" :disabled="!hasBoth">
								<svg id="male" viewBox="0 0 512 512" width="17" height="20" :style="`fill: ${ hasBoth ? 'var(--color-primary)' : '#666'}`">
							...
							<v-btn class="toggle_btn" flat outline color="primary" value="female" :disabled="!hasBoth">
								<svg id="female" height="17" viewBox="0 0 384 384" width="20" :style="`fill: ${ hasBoth ? 'var(--color-primary)' : '#666'}`">
